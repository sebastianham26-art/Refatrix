...
export default async function financeRoutes(app) {
  ...
  app.get('/api/cashflow/month', { preHandler: [authGuard, requirePage('transactions')] }, async (req) => {
    ...
    // ===== 계좌별 일자 잔고 부족 경보 (2026-07-09 도입, 2026-08-04 복원) =====
    ...
    return { month, today, opening_before_month: r2(runBefore), opening_before_month_proj: r2(runBeforeProj), days, carry: carry || null, forecast, acct_alert_low_threshold: ACCT_ALERT_LOW, ...breakdown };
  });
